...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2024 at 03:12 PM
...
ALTER TABLE `enroll_class`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_class_enroll_day_class` (`id_class`),
  ADD KEY `fk_dayclass_enroll_day_class` (`id_dayclass`),
  ADD KEY `fk_user_enroll_day_class` (`prs_nbr`);
...
--
-- Constraints for table `enroll_class`
--
ALTER TABLE `enroll_class`
  ADD CONSTRAINT `fk_class_enroll_day_class` FOREIGN KEY (`id_class`) REFERENCES `class` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_dayclass_enroll_day_class` FOREIGN KEY (`id_dayclass`) REFERENCES `day_class` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
